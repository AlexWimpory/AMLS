...
from A1_feature_pre_processing import feature_pre_processor
from A1_model_plotter import plot_confusion_matrix
...
class ModelEvaluator:
    ...
    def evaluate(self):
        ...
        label_encoder = ModelLabelEncoder.load('A1')
