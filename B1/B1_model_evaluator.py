...
from B1_feature_pre_processing import feature_pre_processor
from numpy.ma import argmax
from B1_model_plotter import plot_confusion_matrix
...
class ModelEvaluator:
    ...
    def evaluate(self):
        ...
        label_encoder = ModelLabelEncoder.load('B1')
